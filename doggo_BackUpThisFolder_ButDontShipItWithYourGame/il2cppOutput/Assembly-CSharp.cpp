...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ARPlaceOnPlane_PlaceObjectByTouch_m0A929AD255DB0ABD600157D1C47CD080B68FAB0A (ARPlaceOnPlane_t3695B37375E8C5125BC61AB920B325B765B69B8B* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (Input.touchCount > 0) // touch? ????? ???? ? ?? (touchCount : ??? ???? ?? ??? ??)
		int32_t L_0;
	...
	{
		// Touch touch = Input.GetTouch(0); // ?? ??? ??? ??? ?? ????. (touch.GetTouch(index) : ??? ?? ??? ??? ??? ???? Touch ??? ??)
		...
		V_1 = L_2;
		// if (arRaycaster.Raycast(touch.position, hits, TrackableType.Planes)) // touch? ??? ???? Ray? ??.
	...
	}
	{
		...
		V_2 = L_9;
		// if (!spawnObject) // ?? ??? ?? ????
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_10 = __this->___spawnObject_6;
	...
	{
		// spawnObject = Instantiate(placeObject, hitPose.position, hitPose.rotation); // touch? ??? ??? ??? ???? ???
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_12 = __this->___placeObject_5;
		...
		__this->___spawnObject_6 = L_17;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___spawnObject_6), (void*)L_17);
		return;
	}
...
IL_006a:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_18 = __this->___spawnObject_6;
		NullCheck(L_18);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_22 = __this->___spawnObject_6;
		NullCheck(L_22);
